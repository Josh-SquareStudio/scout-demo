  ...
  formatOpeningHours() {
    ...
    for (var key in this.venue.opening_hours) {
      ...
      for (var i = 0; i < days.length; i++) {
        ...
        if (i == 0 || i == days.length - 1) { //if first or last day
          ...
          if (!streak) {
            text += " - "
            switch (days[i]) {
              case 1: prevDay = 1; break;
              case 2: prevDay = 2; break;
              case 3: prevDay = 3; break;
              case 4: prevDay = 4; break;
              case 5: prevDay = 5; break;
              case 6: prevDay = 6; break;
              case 7: prevDay = 7; break;
            }
            streak = true;
          }
        }
